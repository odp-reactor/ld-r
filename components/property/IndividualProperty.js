...
class IndividualProperty extends React.Component {
    ...
    render() {
        ...
        if (
            this.props.config &&
            this.props.config.allowNewValue &&
            !this.props.readOnly
        ) {
            propLabel = this.props.config.label
            ...
            if (this.state.inNewValueMode) {
                defaultValueDIV = (
                    <ObjectReactor
                        ...
                        readOnly={false}
                        onCreateIndividualObject={this.props.onCreateIndividualObject.bind(
                            this
                        )}
                    />
                );
                newValueDIV = (
                    <div className="ui list">
                        <div className="item">
                            <div
                                onClick={this.handleCancelNewIndividualObject.bind(
                                    this
                                )}
                                className="medium ui basic icon labeled button"
                            >
                                <i className="cancel square large red icon "></i>{' '}
                                &nbsp; Cancel adding new{' '}
                ...
                newValueDIV = (
                    <div className="ui list">
                        <div className="item">
                            <div
                                onClick={this.handleNewIndividualObject.bind(
                                    this
                                )}
                                className="medium ui basic icon labeled button"
                            >
                                <i className="plus square large blue icon "></i>{' '}
                                &nbsp; New <strong> {propLabel} </strong>
                            </div>
                        </div>
                        <br />
                    </div>
            ...
            <div ref="individualProperty">
                ...
                <div className="property-objects">
                    <ObjectReactor
                        ...
                        onDeleteIndividualObject={this.props.onDeleteIndividualObject.bind(
                            this
                        )}
                        onUpdateIndividualObject={this.props.onUpdateIndividualObject.bind(
                            this
                        )}
                        onDetailCreateIndividualObject={this.props.onDetailCreateIndividualObject.bind(
                            this
                        )}
                        onDetailUpdateIndividualObject={this.props.onDetailUpdateIndividualObject.bind(
                            this
                        )}
                        onUpdateAggObject={this.props.onUpdateAggObject.bind(
                            this
                        )}
                        onDeleteAggObject={this.props.onDeleteAggObject.bind(
                            this
                        )}
