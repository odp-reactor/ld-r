...
import CustomDateTimeView from "./viewer/individual/CustomDateTimeView";
...
class ObjectIViewer extends React.Component {
    render() {
        ...
        if (
            this.props.config &&
            this.props.spec.extended &&
            viewerConfig === "BasicIndividualView"
        ) {
        ...
        if (
            this.props.config &&
            this.props.config.hasBlankNode &&
            extendedViewer
        ) {
            hideObject = 1;
        }
        ...
        return (
            ...
            >
                {hideObject ? (
                    ...
                    <div className={viewerClasses}>{viewer}</div>
                )}
                {extendedViewer}
            </div>
        );
