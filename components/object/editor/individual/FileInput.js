...
class FileInput extends React.Component {
    ...
    onDrop(files) {
        let self = this;
        let filePrefixName =
            this.props.config && this.props.config.fileNamePrefix
        ...
        files.forEach(file => {
            fname =
                ...
                '.' +
                this.getFormatFromName(file.name);
    ...
    render() {
        ...
        let acceptedMimeTypes =
            this.props.config && this.props.config.acceptedMimeTypes
                ? this.props.config.acceptedMimeTypes
                : '';
        let maxFileSize =
            this.props.config && this.props.config.maxFileSize
            ...
            <div ref="fileInput">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isDragActive ? (
                                            ...
                                            <p>
                                                Try dropping your CSV file here,
                ...
                {this.state.status === 1 ? (
                    <div className="progress">
                        ...
                        {this.state.progress}% uploaded. Waiting for the next
                        action to start...
                    </div>
                ) : null}
                {this.state.status === 2 ? (
                    <div className="uploaded">
                        File was successfully uploaded at{' '}
                        <a href={this.state.filePath}>{this.state.filePath}</a>.
                    </div>
                ) : null}
            </div>
        );
