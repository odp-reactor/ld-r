...
class PrefixBasedView extends React.Component {
                        ...
                        if (tmp22.length > 1) {
                            out.push(
                                '[' +
                                    this.makeShorten(
                                        tmp22[0],
                                        this.getPrefix(tmp22[0])
                                    ) +
                                    '>>' +
                                    this.makeShorten(
                                        tmp22[1],
                                        this.getPrefix(tmp22[1])
                                    ) +
                                    ']' +
                                    this.makeShorten(
                                        tmp4i[0],
                                        this.getPrefix(tmp4i[0])
                                    ) +
                                    '||' +
                                    this.makeShorten(
                                        tmp4i[1],
                                        this.getPrefix(tmp4i[1])
                                    )
                            );
                        } else {
                            out.push(
                        ...
                        if (tmp22.length > 1) {
                            out.push(
                                '[' +
                                    ...
                                    ']' +
                                    this.makeShorten(tmp4, this.getPrefix(tmp4))
                            );
                        } else {
                            out.push(
                                '[' +
    ...
    render() {
        ...
        if (
            ...
            this.props.spec.value.indexOf('http://') !== -1
        ) {
