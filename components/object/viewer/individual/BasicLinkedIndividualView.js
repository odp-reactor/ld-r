...
class BasicLinkedIndividualView extends React.Component {
    render() {
        ...
        if (this.props.config) {
            if (
                this.props.config.containerDatasetURI ||
                this.props.containerDatasetURI
            ) {
        ...
        if (
            this.props.openInNewWindows ||
            (this.props.config && this.props.config.openInNewWindows)
        ) {
            outputDIV = (
                <a
                    target="_blank"
                    ...
                    href={
                        ...
                        '/resource/' +
                        encodeURIComponent(this.props.spec.value) +
                        '/' +
                        this.props.category +
                        '/' +
                        encodeURIComponent(this.props.propertyPath)
                    }
                >
