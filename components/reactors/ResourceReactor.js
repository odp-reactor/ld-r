...
class ResourceReactor extends React.Component {
    ...
    render() {
        ...
        let resourceReactor;
        console.log('resourcestore', this.props.ResourceStore);
        console.log('config', config);
        console.log(`[* debug *] properties: ${JSON.stringify(properties)}`);
                        ...
                        <div className="ui column">
                            <div className="ui grey message form">
                                <PrefixBasedInput
                                    ...
                                    noFocus={true}
                                    spec={{ value: '' }}
                                    onDataEdit={this.handleNewPropertyEdit.bind(
                                        this
                                    )}
                                ...
                                <PrefixBasedInput
                                    noFocus={true}
                                    spec={{ value: '' }}
                                    onDataEdit={this.handleNewObjectValueEdit.bind(
                                        this
                                    )}
                                    placeholder="Value of the property"
                                    onEnterPress={this.handleNewProperty.bind(
                                        this
                                    )}
                                ...
                                >
                                    <i className="icon square add"></i>Add
                                    Property/Value
                                </button>
                            </div>
                        </div>
...
ResourceReactor = connectToStores(ResourceReactor, [ResourceStore], function(
    context,
    props
) {
