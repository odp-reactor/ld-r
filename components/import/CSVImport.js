                        ...
                        <div className="ui row">
                            <div className="column">
                                <div className="ui segment content">
                                    <h2>
                                        It is not allowed to import CSV files
                                        based on your current configurations.
                                        Please contact your admin to enable this
                                        feature...
                                    </h2>
                                </div>
                            </div>
                        ...
                        <div className="column">
                            <div className="ui segment content">
                                <h2 className="ui header">
                                    Import CSV files (as JSON-LD RDF Graph)
                                </h2>
                                <section>
                                    <Form size="big">
                                        {!this.state.status ? (
                                            <Form.Field
                                                ...
                                                onChange={this.handleDelimiterChange.bind(
                                                    this
                                                )}
                                        ...
                                        {!this.state.status ? (
                                            <FileInput
                                                onDataEdit={this.handleDataEdit.bind(
                                                    this
                                                )}
                                                config={{
                                                    acceptedMimeTypes:
                                                        'text/*, text/csv, application/csv, application/vnd.ms-excel',
                                        ...
                                        this.props.ImportStore.total ? (
                                                <center>
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={this.handleMappingCreation.bind(
                                                            this
                                                        )}
                                                    >
                                                    Configuration{' '}
