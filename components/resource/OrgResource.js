    ...
    render() {
        ...
        let list = this.props.properties.map(function(node, index) {
            ...
            if (!node.config || !node.config.isHidden) {
                ...
                if (
                    node.propertyURI === 'http://dbpedia.org/ontology/country'
                ) {
                    ocountry = node.instances[0].value;
                }
                if (
                    node.propertyURI === 'http://dbpedia.org/property/country'
                ) {
                        ...
                        <h2>
                            ...
                            >
                                {picture ? (
                                    ...
                                    <i className="blue icon building"></i>
                                )}
                            </a>{' '}
                            ...
                            <div className="ten wide column">
                                <div className="ui huge divided list">
                                    {motto ? (
                                        <div className="item">
                                            {' '}
                                            <div className="ui top black attached fluid compact segment">
                                                <i className="ui icon quote left"></i>
                                                {motto}
                                                <i className="ui icon quote right"></i>
                                            </div>
                                        </div>
                                    ) : (
                                        ''
                                    ...
                                    {city ? (
                                        <div className="item">
                                            <i className="icons">
                                                <i className="ui icon map outline"></i>
                                            </i>{' '}
                                            <a
                                                href={
                                                    '/dataset/' +
                                                    encodeURIComponent(
                                                        self.props.datasetURI
                                                    ) +
                                                    '/resource/' +
                                                    encodeURIComponent(city)
                                                }
                                            >
                                                {URIUtil.getURILabel(city)}
                                            </a>{' '}
                                            |{' '}
                                            {country ? (
                                                <a
