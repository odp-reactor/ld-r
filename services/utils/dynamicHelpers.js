...
export default {
    ...
    getDynamicFacetsConfig: function(user, datasetURI, callback) {
        dynamicConfigurator.prepareDynamicFacetsConfig(
            user,
            datasetURI,
            dynamicConfig => {
    ...
    getDynamicDatasetConfig: function(user, datasetURI, callback) {
        dynamicConfigurator.prepareDynamicDatasetConfig(
            user,
            datasetURI,
            dynamicConfig => {
                callback(dynamicConfig);
    ...
    getDynamicDatasets: function(user, callback) {
        dynamicConfigurator.getDynamicDatasets(
            user,
            (dynamicReactorDS, dynamicFacetsDS) => {
                callback(dynamicReactorDS, dynamicFacetsDS);
            }
        );
    },
    createASampleServerConfig: function(user, datasetURI, options, callback) {
        dynamicConfigurator.createASampleServerConfig(
            user,
            datasetURI,
            options,
            res => {
    ...
    createASampleReactorConfig: function(
        user,
        scope,
        datasetURI,
        resourceURI,
        ...
        dynamicConfigurator.createASampleReactorConfig(
            user,
            scope,
            datasetURI,
            resourceURI,
    ...
    createASampleFacetsConfig: function(
        user,
        configURI,
        datasetURI,
        options,
        ...
        dynamicConfigurator.createASampleFacetsConfig(
            user,
            configURI,
            datasetURI,
            options,
    ...
    createASampleMapping: function(
        ...
        csvMapper.createASampleMapping(
            user,
            filePath,
            delimiter,
            columns,
