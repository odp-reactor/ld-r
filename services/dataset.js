...
export default {
    ...
    read: (req, resource, params, config, callback) => {
        if (resource === 'dataset.resourcesByType') {
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    configurator.prepareDatasetConfig(
                        ...
                        datasetURI,
                        rconfig => {
                            let maxOnPage = parseInt(
                                rconfig.maxNumberOfResourcesOnPage
                            );
                            if (!maxOnPage) {
                                maxOnPage = 20;
                            }
                                ...
                                if (!editAccess.access) {
                                    ...
                                    if (!viewAccess.access) {
                                        callback(null, {
                                            ...
                                            resourceQuery: '',
                                            error:
                                                'You do not have enough permision to access this dataset!'
                                        });
                                        return 0;
                                    }
                                }
                            ...
                            let searchTerm = params.searchTerm
                                ? params.searchTerm
                                : '';
                            query2 = queryObject.getResourcesByType(
                                endpointParameters,
                                graphName,
                                searchTerm,
                                rconfig,
                            ...
                            rp.get({
                                ...
                                .then(function(res) {
                                    callback(null, {
                                        datasetURI: datasetURI,
                                        graphName: graphName,
                                        resources: utilObject.parseResourcesByType(
                                            user,
                                            res,
                                            datasetURI,
                                            rconfig
        ...
        } else if (resource === 'dataset.patternCollection') {
            query1;
            query2;
                ...
                endpointParameters => {
                    ...
                    configurator.prepareDatasetConfig(
                        ...
                        rconfig => {
                            ...
                            query = queryObject.countResourcesByType(
                                endpointParameters,
                                graphName,
                                rconfig
                            );
                            ...
                            rp.get({
                                ...
                                .then(function(res) {
                                    callback(null, {
                                        datasetURI: datasetURI,
                                        graphName: graphName,
                                        total: utilObject.parseCountResourcesByType(
                                            res
                                        )
                                    });
                                })
            ...
            let resourceType = params.resourceType
                ? decodeURIComponent(params.resourceType)
                : 0;
            let propertyURI = params.propertyURI
                ? decodeURIComponent(params.propertyURI)
                : 0;
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    configurator.prepareDatasetConfig(
                        ...
                        datasetURI,
                        rconfig => {
                            let maxOnPage = rconfig.maxNumberOfResourcesOnPage
                                ? parseInt(rconfig.maxNumberOfResourcesOnPage)
                                : 20;
                            maxOnPage = params.maxOnPage
                                ? parseInt(params.maxOnPage)
                                : maxOnPage;
                            let page = params.page ? params.page : 1;
                            let offset = (page - 1) * maxOnPage;
                            query = queryObject.getResourcePropForAnnotation(
                                endpointParameters,
                                graphName,
                                rconfig,
                                resourceType,
                                ...
                                .then(function(res) {
                                    callback(null, {
                                        ...
                                        resourceType: resourceType
                                            ? [resourceType]
                                            : rconfig.resourceFocusType,
                                        propertyURI: propertyURI,
                                        graphName: graphName,
                                        resources: utilObject.parseResourcePropForAnnotation(
                                            res
                                        )
                                    });
                                })
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    configurator.prepareDatasetConfig(
                        ...
                        targetDataset,
                        rconfig => {
                            query = queryObject.countAnnotatedResourcesWithProp(
                                endpointParameters,
                                endpointParameters.graphName,
                                rconfig,
                                resourceType,
                                propertyURI,
                                params.inANewDataset
                            );
                            //console.log(query);
                            //build http uri
                            //send request
                            rp.get({
                                ...
                                .then(function(res) {
                                    callback(null, {
                                        ...
                                        propertyURI: propertyURI,
                                        graphName: endpointParameters.graphName,
                                        annotated: utilObject.parseCountAnnotatedResourcesWithProp(
                                            res
                                        )
                                    });
                                })
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    configurator.prepareDatasetConfig(
                        ...
                        datasetURI,
                        rconfig => {
                            query = queryObject.countTotalResourcesWithProp(
                                endpointParameters,
                                graphName,
                                rconfig,
                                resourceType,
                            ...
                            rp.get({
                                ...
                                .then(function(res) {
                                    callback(null, {
                                        ...
                                        propertyURI: propertyURI,
                                        graphName: graphName,
                                        total: utilObject.parseCountTotalResourcesWithProp(
                                            res
                                        )
                                    });
                                })
            ...
            if (enableAuthentication) {
                if (!req.user) {
                    callback(null, {
                        dynamicReactorDS: { datasets: {} },
                        dynamicFacetsDS: { facets: {} },
                        staticReactorDS: staticReactorDS,
                        staticFacetsDS: staticFacetsDS
                    });
                    return 0;
                } else {
                    user = req.user;
            ...
            sources.forEach(function(s) {
                for (let ds in staticReactor.config[s]) {
                    if (
                        ds !== authDatasetURI[0] &&
                        ds !== configDatasetURI[0] &&
                        ds !== mappingsDatasetURI[0] &&
                        ds !== 'generic'
                    ) {
