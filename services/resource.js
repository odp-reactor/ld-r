...
import {
    ...
    createASampleFacetsConfig,
    createASampleServerConfig,
    createAnEnvState,
    getSavedQueries
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    rp.get({
                        ...
                        .then(function(res) {
                            utilObject.parseObjectProperties(
                                user,
                                res,
                                datasetURI,
                                resourceURI,
        ...
        if (resource === 'resource.individualObject') {
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    if (params.delimitedBy) {
                        ...
                        let delTmp = params.objectValue.split(
                            params.delimitedBy
                        );
                        delTmp.forEach(dval => {
                            query =
                                query +
                                queryObject.addTriple(
                                    endpointParameters,
                                    graphName,
                                    params.resourceURI,
                                    params.propertyURI,
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    query =
                        queryObject.getPrefixes() +
                        queryObject.createObjectDetails(
                            endpointParameters,
                            user,
                            graphName,
                            params.resourceURI,
                            params.propertyURI,
                            params.oldObjectValue,
                            params.newObjectValue,
                            params.valueType,
                            params.dataType,
                            params.detailData
                        );
            ...
            let newResourceURI =
                datasetURI + '/c' + Math.round(+new Date() / 1000);
            ...
            let newResourceURI =
                baseResourceDomain[0] + '/n' + Math.round(+new Date() / 1000);
            //do not add two slashes
            if (
                baseResourceDomain[0].slice(-1) === '/' ||
                baseResourceDomain[0].slice(-1) === '#'
            ) {
                newResourceURI =
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    query =
                        queryObject.getPrefixes() +
                        queryObject.newResource(
                            endpointParameters,
                            user,
                            graphName,
                            newResourceURI,
                            params.templateResource
                        );
                    HTTPQueryObject = getHTTPQuery(
                        'update',
                        query,
            ...
            if (
                sparqlEndpoint['generic'] &&
                sparqlEndpoint['generic'].endpointType
            ) {
            ...
            let sresourceURI =
                configDatasetURI[0] + '/fcf' + Math.round(+new Date() / 1000);
            createASampleFacetsConfig(
                req.user,
                sresourceURI,
                params.dataset,
            ...
            let sresourceURI =
                configDatasetURI[0] + '/state' + Math.round(+new Date() / 1000);
        ...
        if (resource === 'resource.individualObject') {
            ...
            getDynamicEndpointParameters(
                ...
                endpointParameters => {
                    ...
                    query =
                        queryObject.getPrefixes() +
                        queryObject.updateObjectTriples(
                            endpointParameters,
                            graphName,
                            params.resourceURI,
                            params.propertyURI,
