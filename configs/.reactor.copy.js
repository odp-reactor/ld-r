    ...
    config: {
		...
		allowResourceClone: 1,
            ...
            'http://dbpedia.org/sparql/': {
                readOnly: 0,
                //allowInlineConfig: 0,
                resourceFocusType: ['http://dbpedia.org/ontology/University', 'http://dbpedia.org/ontology/EducationalInstitution'],
                //resourceLabelProperty: ['http://xmlns.com/foaf/0.1/name'],
                datasetLabel: ['Universities']
            },
		...
		category: ['General'],
		label: ['Time Indexed Typed Location']
	   },
            ...
            'http://dbpedia.org/ontology/foundingYear': {
                category: ['Specific'],
                label: ['Funding Year'],
                objectIViewer: ['CustomDateTimeView']
            },
            'http://dbpedia.org/ontology/numberOfStudents': {
                category: ['Specific'],
                label: ['Number of Students']
            },
            'http://dbpedia.org/ontology/numberOfGraduateStudents': {
                category: ['Specific'],
                label: ['Number of Graduate Students']
            },
